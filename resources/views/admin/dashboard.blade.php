...
<div class="row mt-5">
    ...
    <!-- Overview Summary -->
    <div class="mt-5 row  col-sm-12 mb-5 mx-auto  ">
        
        <div class="col-sm-1">
           
        </div>
        <div class="col-sm-2  custom-border-right text-light  py-4 text-center" style="background-color:rgb(198, 159, 4)">
            <p style="font-size:20px;font-weight:bold">{{ $totalBookingCount }}</p> 
            <strong>Payment Bookings</strong>
        </div>
        <div class="col-sm-2 custom-border-right  text-light  py-4 text-center" style="background-color:rgba(21, 125, 38, 0.87)">
            <p style="font-size:20px;font-weight:bold">{{ number_format($totalRevenue, 2) }}</p> 
            <strong>Total Revenue</strong>
        </div>
        <div class="col-sm-2 custom-border-right text-light  py-4 text-center" style="background-color:rgb(241, 106, 69)">
            <p style="font-size:20px;font-weight:bold">{{ $totalBookingCount_pending }}</p> 
            <strong>Pending Payments</strong>
        </div>
        <div class="col-sm-2 custom-border-right text-light  py-4 text-center" style="background-color:rgb(97, 157, 242)">
            <p style="font-size:20px;font-weight:bold">{{ number_format($totalPending, 2) }}</p> 
            <strong>Due Amount</strong>
        </div>

        <div class="col-sm-2 custom-border-right text-light  py-4 text-center" style="background-color:rgb(97, 172, 242)">
            <p style="font-size:20px;font-weight:bold">{{ $discountcount }}</p> 
            <strong>Discounted Bookings</strong>
        </div>
        <div class="col-sm-1">
